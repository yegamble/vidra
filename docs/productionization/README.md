...
| Phase | Scope | Status |
|---|---|---|
| 1 | Production-ready basic install: installer, setup engine, web wizard, `vidra` CLI, doctor/update, managed Caddy, owner bootstrap | **In progress** (started 2026-08-19) |
