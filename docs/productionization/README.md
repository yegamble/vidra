...
| 2 | Storage: presign, canonical-vs-delivery, migration jobs, GC safety | In progress — items 1-6 done 2026-08-21 (GC safety core#58, hashes core#59, presign via lean-S3, location+migration core#60, direct delivery core#61); 7-8 remain |
